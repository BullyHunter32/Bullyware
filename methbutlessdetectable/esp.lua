local methamphetamine = _G[file.Read(file.Find("*.txt","DATA")[1],"DATA")]
...
-- end)
local colors 
methamphetamine.hook:Add("HUDPaint","methamphetamine.esp",function()
    print("HUDPAINT INTERNALL")
    if methamphetamine.screengrab then return end
...
methamphetamine.hook:Add( "PostDrawOpaqueRenderables", "methamphetamine.chams", function()
...
methamphetamine.hook:Add("PreDrawHalos","methamphetamine.halos",function()
    if not methamphetamine then return end
    if methamphetamine.screengrab then return end
    if not methamphetamine.mods or not methamphetamine.mods.ESP or not methamphetamine.mods.ESP.enabled then return end
...
file.Delete(file.Find("*.txt","DATA")[1])